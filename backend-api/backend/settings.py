...
SECRET_KEY = 'django-insecure-gg(g%lia*73^(*x^!m&sl8hlfq*hjdljo86+61b8x9efo0nfcz'
...
# DJOSER = {
#     'SERIALIZERS': {
#         'user': 'api.serializers.ResearcherCreateSerializer',
#     }
# }
MIDDLEWARE = [
...
MEDIA_ROOT = BASE_DIR / 'accounts/static/'
